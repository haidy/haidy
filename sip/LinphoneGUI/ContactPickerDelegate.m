...
- (BOOL)peoplePickerNavigationController:(ABPeoplePickerNavigationController *)peoplePicker 
	...
	NSString *phoneNumber = (__bridge NSString *)ABMultiValueCopyValueAtIndex(multiValue, valueIdx);
	[[LinphoneManager instance].callDelegate displayDialerFromUI:nil 
														 forUser:phoneNumber 
												 withDisplayName:(__bridge NSString*)ABRecordCopyCompositeName(person) ];
