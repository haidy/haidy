...
static void audioRouteChangeListenerCallback (
    ...
    [(__bridge UISpeakerButton*)inUserData reset];  
...
-(void) initWithOnImage:(UIImage*) onImage offImage:(UIImage*) offImage debugName:(const char *)name{
   ...
   OSStatus lStatus = AudioSessionAddPropertyListener(routeChangeID, audioRouteChangeListenerCallback, (__bridge void *)(self));
   if (lStatus) {
...
- (void)dealloc {
    OSStatus lStatus = AudioSessionRemovePropertyListenerWithUserData(routeChangeID, audioRouteChangeListenerCallback, (__bridge void *)(self));
	if (lStatus) {
